                ...
                <div id="middle-section" class="flexbox center-news" style="margin-top: 0;">
                    ...
                    <table border="1" cellpadding="2" cellspacing="2">
                        ...
                        $result = mysqli_query($connection,
                            "select team_name, wins, loss, conf_win, div_win, conf_loss, 
                                    div_loss, home_win, away_win, home_loss, away_loss 
                                    from leaderboard l join team t on l.team_idteam = t.idteam 
                                    where season_idseason = '".$temp."'and (wins <> 0 and loss <> 0) 
                                    order by wins desc");
                        ...
                        while($query_data = mysqli_fetch_row($result)) {
                            ...
                            echo "<td>",$query_data[0], "</td>",
                                 "<td>",$query_data[1], "</td>",
                                 "<td>",$query_data[2], "</td>",
                                 "<td>",$query_data[3]," - ",$query_data[5],"</td>",
                                 "<td>",$query_data[4]," - ",$query_data[6],"</td>",
                                 "<td>",$query_data[7]," - ",$query_data[9],"</td>",
                                 "<td>",$query_data[8]," - ",$query_data[10],"</td>";
                            echo "</tr>";
                        }
                        ?>
