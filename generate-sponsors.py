...
# Fake companies - http://www.generatedata.com/#generator

# Sponsor companies
real = ['Stubhub', 'Volkswagen',    'Starbucks',    'Vans',         'Pizza Hut',
        'Fossil',  'Github',        'Spotify',      'TD Bank',      'Samsung',
        'Fitbit',  'Western Union', 'Microsoft',    'Rakuten',      'Wish',
        'Sony',    'Palantir',      'Lending Tree', 'Credit Karma', 'Apple']
...
streetPrefix = ['1ST', '2ND', '3RD', '4TH', '5TH', '6TH', '7TH', '8TH', '9TH', '10TH',
                ...
                'GIRARD','GLADEVIEW','GLADIOLUS','GLADSTONE','GLADYS','GLEN','GLENBROOK','GLENDALE',
                'GLENHAVEN','GLENVIEW','GLOBE','GLORIA','GLOVER','GODEUS',
                'GOETHE','GOETTINGEN','GOLD','GOLD MINE','GOLDBERG','GOLDEN','GOLDEN GATE','GOLDING','GOLETA','GOLF COURSE ACCESS','GONZALEZ',
                'GORDON','GORGAS','GORHAM','GOUGH','GOULD','GRACE','GRAFTON','GRAHAM','GRANADA',
                'GRAND VIEW','GRANT','GRANVILLE','GRATTAN','GRAYSTONE',
                'GREAT','GREELY','GREEN','GREENOUGH','GREENVIEW','GREENWICH','GREENWOOD','GRENARD',
                'GRIFFITH','GRIJALVA','GROTE','GROVE','GUERRERO','GUTTENBERG','GUY',
                ...
                'HYDE','I','I-280 N OFF','I-280 N ON','I-280 NORTHBOUND','I-280 S OFF','I-280 S ON','I-280 SOUTHBOUND',
                'I-280 TO HWY 101','I-80 E OFF','I-80 E ON',
                ...
                'JUNIOR','JUNIPER','JUNIPERO SERRA','JUNIPERO SERRA BLVD OFF','JUNIPERO SERRA BLVD ON',
                'JURI','JUSTIN','KALMANOVITZ','KAMILLE','KANSAS','KAPLAN',
...
with open('data/sponsors.csv', mode='w') as sponsor_file:
    sponsor_writer = csv.writer(sponsor_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    ...
    while index < len(real):
        ...
        # Sponsor ID
        sponsor.append(index+1)

        # Company name
        sponsor.append(real[index])
        ...
        # Address
        sponsor.append(str(addNum) + " " + streetPrefix[addPre].title() + " " + streetSuffix[addSuf])
        ...
        sponsor.append("1-" + str(phoneArea) + '-' + str(phonePre) + '-' + str(phoneSuf))
        index += 1

        sponsor_writer.writerow(sponsor)